...
The 'reficio' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] reficio_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/reficio.job.yml). The schedule
